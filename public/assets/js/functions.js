...
var e = {
    ...
    if (e.isVariableDefined($carousel)) {
        ...
        tnsCarousel.forEach(slider => {
            ...
            // 🔥 Custom prev/next click handling
            var prevBtn = slider.parentNode.querySelector('.tns-controls button[data-controls="prev"]');
            var nextBtn = slider.parentNode.querySelector('.tns-controls button[data-controls="next"]');
