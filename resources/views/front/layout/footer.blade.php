        ...
        <div class="row g-4">
            ...
            <div class="col-lg-3">
                ...
                <a class="me-0" href="index.php">
                    <img class="light-mode-item h-40px" src="assets/images/finallogo2.png" alt="logo" height="100px">
                    <img class="dark-mode-item h-40px" src="assets/images/finallogo2.png" alt="logo">
                </a>
