                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="roleMenu">
                            <li><a class="dropdown-item" href="register-instructor.html">I am Instructor</a></li>
                            <li><a class="dropdown-item" href="register-student.html">I am Student</a></li>
                            <li><a class="dropdown-item" href="register-mentor.html">I am Mentor</a></li>
                        </ul>
                    </li>
                </ul>
