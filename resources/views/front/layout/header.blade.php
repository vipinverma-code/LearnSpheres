                ...
                <ul class="navbar-nav navbar-nav-scroll mx-auto">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="pagesMenu">
                            ...
                            <li class="dropdown-submenu dropend">
                                ...
                                <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                    ...
                                    <li> <a class="dropdown-item" href="course-detail.php">Course Detail Classic</a>
                                    </li>
                                    <li> <a class="dropdown-item" href="course-detail-min.php">Course Detail Minimal</a>
                                    </li>
                                    <li> <a class="dropdown-item" href="course-detail-adv.php">Course Detail Advance</a>
                                    </li>
                                    <li> <a class="dropdown-item" href="course-detail-module.php">Course Detail
                                            Module</a></li>
                                    <li> <a class="dropdown-item" href="course-video-player.php">Course Full Screen
                                            Video</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="dropdown-submenu dropend">
                                ...
                                <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                    ...
                                    <li> <a class="dropdown-item" href="shop-product-detail.php">Product detail</a>
                                    </li>
                            ...
                            <li class="dropdown-submenu dropend">
                                ...
                                <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                    ...
                                    <li> <a class="dropdown-item" href="help-center-detail.php">Help Center Single</a>
                                    </li>
                            ...
                            <li class="dropdown-submenu dropend">
                                ...
                                <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                    ...
                                    <li> <a class="dropdown-item" href="university-admission-form.php">Admission
                                            Form</a></li>
                                </ul>
                            </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="accounntMenu">
                            ...
                            <li class="dropdown-submenu dropend">
                                ...
                                <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                    <li> <a class="dropdown-item" href="instructor-dashboard.php"><i
                                                class="bi bi-grid-fill fa-fw me-1"></i>Dashboard</a> </li>
                                    <li> <a class="dropdown-item" href="instructor-manage-course.php"><i
                                                class="bi bi-basket-fill fa-fw me-1"></i>Courses</a> </li>
                                    <li> <a class="dropdown-item" href="instructor-create-course.php"><i
                                                class="bi bi-file-earmark-plus-fill fa-fw me-1"></i>Create Course</a>
                                    </li>
                                    <li> <a class="dropdown-item" href="course-added.php"><i
                                                class="bi bi-file-check-fill fa-fw me-1"></i>Course Added</a> </li>
                                    <li> <a class="dropdown-item" href="instructor-quiz.php"><i
                                                class="bi bi-question-diamond fa-fw me-1"></i>Quiz</a> </li>
                                    <li> <a class="dropdown-item" href="instructor-earning.php"><i
                                                class="fas fa-chart-line fa-fw me-1"></i>Earnings</a> </li>
                                    <li> <a class="dropdown-item" href="instructor-studentlist.php"><i
                                                class="fas fa-user-graduate fa-fw me-1"></i>Students</a> </li>
                                    <li> <a class="dropdown-item" href="instructor-order.php"><i
                                                class="bi bi-cart-check-fill fa-fw me-1"></i>Orders</a> </li>
                                    <li> <a class="dropdown-item" href="instructor-review.php"><i
                                                class="bi bi-star-fill fa-fw me-1"></i>Reviews</a> </li>
                                    <li> <a class="dropdown-item" href="instructor-payout.php"><i
                            ...
                            <li class="dropdown-submenu dropend">
                                ...
                                <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                    <li> <a class="dropdown-item" href="student-dashboard.php"><i
                                                class="bi bi-grid-fill fa-fw me-1"></i>Dashboard</a> </li>
                                    <li> <a class="dropdown-item" href="student-subscription.php"><i
                                                class="bi bi-card-checklist fa-fw me-1"></i>My Subscriptions</a> </li>
                                    <li> <a class="dropdown-item" href="student-course-list.php"><i
                                                class="bi bi-basket-fill fa-fw me-1"></i>Courses</a> </li>
                                    <li> <a class="dropdown-item" href="student-course-resume.php"><i
                                                class="far fa-fw fa-file-alt me-1"></i>Course Resume</a> </li>
                                    <li> <a class="dropdown-item" href="student-quiz.php"><i
                                                class="bi bi-question-diamond fa-fw me-1"></i>Quiz </a> </li>
                                    <li> <a class="dropdown-item" href="student-payment-info.php"><i
                                                class="bi bi-credit-card-2-front-fill fa-fw me-1"></i>Payment Info</a>
                                    </li>
                                    <li> <a class="dropdown-item" href="student-bookmark.php"><i
                            ...
                            <li> <a class="dropdown-item" href="instructor-edit-profile.php"><i
                                        class="fas fa-fw fa-edit me-1"></i>Edit Profile</a> </li>
                            <li> <a class="dropdown-item" href="instructor-setting.php"><i
                                        class="fas fa-fw fa-cog me-1"></i>Settings</a> </li>
                            <li> <a class="dropdown-item" href="instructor-delete-account.php"><i
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end min-w-auto" data-bs-popper="none">
                            <li>
                                <a class="dropdown-item" href="https://1.envato.market/stackbros-portfolio/"
                                    target="_blank">
