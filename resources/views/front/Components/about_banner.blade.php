      ...
      <div class="container">
          <div class="row g-4">
              ...
              <div class="col-10 text-center mx-auto position-relative">
                  ...
                  <!-- Title -->
                  <h1 class="position-relative fs-2">LearnSphere combines structured learning, real-time mentorship, and intelligent support into one platform.</h1>
              </div>
              <!-- Title and SVG END -->
          </div>
                  ...
                  <div class="row g-4">
                      ...
                      <div class="col-sm-6 col-md-12">
                          <div class="bg-grad rounded-4 p-5 text-start">
                              ...
                              <h3 class="text-white">“Be open to new ideas and approaches. Develop your problem-solving
                                  skills.”</h3>
                          </div>
                      </div>
                      <!-- Image -->
